# The Complete AI Learning Roadmap & Progress Tracker

This document contains a complete, project-based roadmap for learning AI and a tracker to monitor your progress.
...
* #### **Step 11: Specialization (University Level)**
...
## Part 2: Your Progress Tracker

**Instructions:** Update the `Status` column as you go (`Not Started` ⏳, `In Progress` 👨‍💻, `Completed` ✅). Add the date and any personal notes or links to your projects.

### Phase 1: Your First AI Application

| Step / Resource | Status | Date Completed | Notes / Project Link |
| :--- | :---: | :---: | :--- |
| **Step 1: Learn APIs** | ⏳ | | |
| ↳ [OpenAI API Quickstart](https://platform.openai.com/docs/quickstart?context=python) | ⏳ | | |
| ↳ [Video: OpenAI API for Beginners](https://www.youtube.com/watch?v=9M42iVnQo_A) | ⏳ | | |
| **Step 2: Learn Prompt Engineering** | ⏳ | | |
| ↳ [Course: ChatGPT Prompt Engineering](https://www.deeplearning.ai/short-courses/chatgpt-prompt-engineering-for-developers/) | ⏳ | | |
| ↳ [Lecture: Stanford Prompt Engineering](https://www.youtube.com/watch?v=d_K4-k2-G3A) | ⏳ | | |
| **Step 3: Project 1** | ⏳ | | |
| ↳ [Build Your Own AI Assistant](https://www.youtube.com/watch?v=zR_4M3_Ei6s) | ⏳ | | |

### Phase 2: Building Your Own Models

| Step / Resource | Status | Date Completed | Notes / Project Link |
| :--- | :---: | :---: | :--- |
| **Step 4: Learn the ML Toolkit** | ⏳ | | |
| ↳ [Course: Data Analysis with Python](https://www.youtube.com/watch?v=r-uOLxNrNk8) | ⏳ | | |
| **Step 5: Learn Core ML Concepts** | ⏳ | | |
| ↳ [Playlist: StatQuest ML Fundamentals](https://www.youtube.com/playlist?list=PLblh5JKOoLUICTaGLRoHQDuF_7q2GfuJF) | ⏳ | | |
| **Step 6: Project 2** | ⏳ | | |
| ↳ [ML for Beginners: Titanic Project](https://www.youtube.com/watch?v=i_LwzRVP7bg) | ⏳ | | |

### Phase 3: Entering the World of Deep Learning

| Step / Resource | Status | Date Completed | Notes / Project Link |
| :--- | :---: | :---: | :--- |
| **Step 7: Learn Neural Networks** | ⏳ | | |
| ↳ [Video Series: 3Blue1Brown Neural Networks](https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi) | ⏳ | | |
| ↳ [Lecture: MIT Intro to Deep Learning](https://www.youtube.com/watch?v=QDX-1M5LzaY) | ⏳ | | |
| **Step 8: Learn a DL Framework** | ⏳ | | |
| ↳ [Course: PyTorch for Deep Learning](https://www.youtube.com/watch?v=Z_ikDlimN6A) | ⏳ | | |
| **Step 9: Project 3** | ⏳ | | |
| ↳ [PyTorch Computer Vision Tutorial](https://www.youtube.com/watch?v=V_xro1bcAuA) | ⏳ | | |

### Phase 4: Expanding Your Power (Ongoing)

| Step / Resource | Status | Date Completed | Notes / Project Link |
| :--- | :---: | :---: | :--- |
| **Step 10: Foundational Math & Stats** | ⏳ | | |
| ↳ [Course: MIT Linear Algebra](https://www.youtube.com/playlist?list=PLE7DDD91010BC51F8) | ⏳ | | |
| ↳ [Video Series: 3Blue1Brown Calculus](https://www.youtube.com/playlist?list=PLZHQObOWTQDMsr9K-rj53DwVRMYO3t57w) | ⏳ | | |
| ↳ [Course: Harvard Statistics 110](https://www.youtube.com/playlist?list=PL2SOU6wwxB0uwwH80KTQ6ht6O2SoKASim) | ⏳ | | |
| **Step 11: Specialization** | ⏳ | | |
| ↳ [Course: Stanford CS224N (NLP)](https://www.youtube.com/playlist?list=PLoROMvodv4rOSH4v6133s9LFPRHjEmbmJ) | ⏳ | | |
| ↳ [Course: Stanford CS231N (Computer Vision)](https://www.youtube.com/playlist?list=PL3FW7Lu3i5JvHM8ljYj-zLfQRF3EO8sYv) | ⏳ | | |
